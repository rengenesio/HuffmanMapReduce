...
public class DecoderSequential {
	...
	public DecoderSequential(String compressedPath, String decompressedFileName, String codificationFileName) throws IOException {
	...
	public void fileToCodification(String codificationFileName) throws IOException {
		FSDataInputStream inputStream = fileSystem.open(new Path(codificationFileName));
...
//		System.out.println("------------------------------");
	...
	System.out.println(String.format("Número de bytes que já li: ", totalReadBytes));
	System.out.println(String.format("Estou neste byte: ", totalReadBytes + j/8));
